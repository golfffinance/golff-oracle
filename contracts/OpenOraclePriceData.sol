...
contract OpenOraclePriceData is OpenOracleData {
    ...
    function put2(address source, uint64 timestamp, string memory key, uint64 value) external returns (string memory) {
        require(msg.sender == reporter, "Report unauthorized");
        return putInternal(source, timestamp, key, value);
    }
